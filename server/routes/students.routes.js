...
// router.post('/gt_st', async (req, res) => {
//   try {
//     const { id } = req.body
...
//       return res
//         .status(400)
//         .json({ message: '[INFO] Class not find!', flag: '#66D9BD' })
//     }

//     let studentArray = []

//     students.student.map(async (elem) => {
//       let student = await User.findById(elem)
//       if (student && student.login) {
//         studentArray.push(student.login)
//       }
//       if (studentArray.length === students.student.length) {
//         console.log(studentArray)
//         return res.send({ students: studentArray })
//       }
//     })
//   } catch (e) {
//     console.log(e)
...
//     return res
//       .status(400)
//       .json({ message: '[INFO] Class not found!', flag: '#66D9BD' })
//   }
...
//     return res
//       .status(400)
//       .json({ message: '[INFO] User not found!', flag: '#66D9BD' })
//   }
...
//     ClassDb.student.forEach(async (elem, i) => {
//       let student = await User.findById(elem)
...
//       if (studentRateArray.length === ClassDb.student.length) {
//         GradesDb.forEach((elem, i) => {
//           if (elem.class === class_) {
//             if (elem.attendance) {
//               studentGradeArray.push({
//                 name: elem.description,
//                 type:
//                   elem.type.charAt(0).toUpperCase() +
//                   elem.type.slice(1).toLowerCase(),
//                 rate: 1,
//                 date: elem.date,
//               })
//             } else {
...
//     ClassDb.student.map(async (elem, i) => {
//       let student = await User.findById(elem)
//       let gradeDb = await Grades.find({
//         students: elem,
//         class: class_,
...
//           if (i + 1 === NewsDb.length) {
//             return res.status(201).json({
//               news: teacherNewsArray.sort((a, b) =>
//                 Date.parse(a.date) > Date.parse(b.date) ? 1 : -1,
//               ),
//               students: studentRateArray.sort((a, b) =>
//                 a.rate < b.rate ? 1 : -1,
//               ),
//             })
//           }
...
// } catch (e) {
//   console.log(e)
//   return res.status(500).json({ message: '[INFO] Router post error!' })
// }
// })

// router.post('/get_chart_grade', async (req, res) => {
// try {
...
//         })
//       } else {
//         return Chart_data_attendance.push({
//           student: elem.students,
//           date: [
//             elem.date
//               .split('.')
//               .reverse()
...
//     data2[elem] = (data2[elem] / AttendanceDb.counter[i]) * 100 || 0
//   })
...
// router.post('/get_chart_type_grades', async (req, res) => {
//   try {
//     const { id, class_, user } = req.body
...
//             data[i].homework.reduce((previous, current) => previous + current) /
...
//         {
//           label: 'Classwork',
//           data: data[5].classwork,
//           borderColor: '#EAC15A',
//         },
//         {
//           label: 'Examination',
//           data: data[4].examination,
//           borderColor: '#D1557A',
//         },
//         {
//           label: 'Test',
...
//         {
//           label: 'Practical',
//           data: data[3].practical,
//           borderColor: '#000000',
//         },
//       ]

//       return res.status(201).json({ data: final_data, avarage })
//     } else {
//       return res.status(201).json({ data: final_data, avarage })
//     }
//   } catch (error) {
